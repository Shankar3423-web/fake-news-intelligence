...
class VersionManager:
    ...
    (e.g., feedback_v1, feedback_v2) associated with each pipeline run.
    """
    def __init__(self, versions_file_path: str = "ml/feedback/versions/feedback_versions.json") -> None:
    ...
    def register_version(
        ...
        version_str = f"feedback_v{version_num}"
        ...
        try:
            ...
            logger.info(f"Registered feedback version '{version_str}' in {self.versions_file_path}")
        except Exception as e:
