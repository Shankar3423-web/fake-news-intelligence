...
class HashGenerator:
    """
    HashGenerator computes SHA-256 integrity checksums for feedback artifacts,
    saving them in a central JSON registry.
    """
    def __init__(self, hash_file_path: str = "ml/feedback/hashes/feedback_hashes.json") -> None:
