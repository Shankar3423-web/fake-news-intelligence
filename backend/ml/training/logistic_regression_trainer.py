...
class LogisticRegressionTrainer(BaseModelTrainer):
    """
    Trainer for Logistic Regression classifier.
    ...
    def train(self, X_train: pd.DataFrame, y_train: pd.Series, split_info: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.info(f"Logistic Regression training complete in {duration} seconds. Memory used: {mem_used} MB.")
        return self.training_summary

    def save(self, output_dir: str) -> Dict[str, str]:
        """
        Saves the model and its metadata into outputs/models/logistic_regression/.
        """
        ...
        logger.info(f"Saving Logistic Regression files to {model_dir}...")
