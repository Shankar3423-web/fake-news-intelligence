...
class XgBoostTrainer(BaseModelTrainer):
    ...
    def train(self, X_train: pd.DataFrame, y_train: pd.Series, split_info: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.info(f"XGBoost training complete in {duration} seconds. Memory used: {mem_used} MB.")
        return self.training_summary

    def save(self, output_dir: str) -> Dict[str, str]:
        """
        Saves the model and its metadata into outputs/models/xgboost/.
        """
        ...
        logger.info(f"Saving XGBoost files to {model_dir}...")
