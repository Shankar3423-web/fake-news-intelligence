...
from ml.training.training_utils import get_memory_usage

logger = logging.getLogger("model_training_pipeline")

class TrainingProfiler:
    """
    Profiler helper for measuring time and memory utilization of pipeline phases.
    ...
    def profile(phase_name: str) -> Generator[Dict[str, Any], None, None]:
        ...
        Usage:
            with TrainingProfiler.profile("Random Forest Training") as stats:
                # training code here
        """
        ...
        # Dictionary to store results, which will be populated after yield
        stats: Dict[str, Any] = {}
